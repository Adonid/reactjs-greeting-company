...
class AddGreetingModal extends Component {
    ...
    sendData = () => {
        ...
        this.props.getDataGreeting(data);
        this.hideModal();
    }
                            ...
                            <div className="main-card card">
                                <div className="card-header">
                                    <span className="d-block">
                                        ...
                                        Thêm mới một nội dung giới thiệu
                                    </span>
                                </div>
                                ...
                                <PerfectScrollbar style={{maxHeight: '440px', padding: '3px'}}>
                                    <div className="position-relative row form-group">
                                        ...
                                        <div className="col-sm-10">
                                            <input onChange={e => this.isChange(e)} name="title" id="title-gretting" type="text" className="form-control" />
                                        </div>
                                    </div>
                                    <div className="position-relative row form-group">
                                        <label htmlFor="sort-gretting" className="col-sm-2 col-form-label">Mô tả chủ đề: </label>
                                        <div className="col-sm-10">
                                            <textarea onChange={e => this.isChange(e)} name="short" className="form-control" id="sort-gretting" rows={2} defaultValue={""} />
                                        </div>
                                    </div>
                                    <div className="position-relative row form-group">
