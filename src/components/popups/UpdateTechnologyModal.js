...
class UpdateTechnologyModal extends Component {
    constructor(props) {
        super(props);
        this.state={
            showIcon: false,
    ...
    // HIDE MODAL
    hideModal = () => this.props.hideModalEditTech(false);
    // END HIDE MODAL
    ...
    sendData = () => {
        ...
        this.props.updateDataTech(data);
        this.hideModal();
    }
    // END SAVE EIDT
    ...
    render() {
        return (
            <Modal show={this.props.editTechnology} size="lg" backdrop="static">
                        ...
                        <div className="col pl-0 pr-0 pt-0 pb-0">
                            <div className="main-card card">
                                ...
                                <PerfectScrollbar style={{maxHeight: '440px', padding: '3px'}}>
                                        ...
                                        <div className="position-relative row form-group">
                                            <label htmlFor="sort-solution" className="col-sm-2 col-form-label">Mô tả chủ đề: </label>
                                            <div className="col-sm-10">
                                                <textarea onChange={(e) => this.isChange(e)} defaultValue={this.state.short} name="short" className="form-control" id="sort-solution" rows={3}/>
                                            </div>
                                        </div>
                                        <div className="position-relative row form-group">
                                        ...
                                        <div className="position-relative row form-group">
                                            ...
                                            <div className="col-sm-10">
                                                <select onChange={(e) => this.isChange(e)} defaultValue={this.state.post} name="linkpost" className="form-control-sm form-control" id="link-to-post">
