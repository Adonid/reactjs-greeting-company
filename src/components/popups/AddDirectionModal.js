...
class AddDirectionModal extends Component {
    constructor(props) {
        super(props);
        this.state={
            showIcon: false,
    ...
    // HIDE MODAL
    hideModal = () => this.props.hideModalAddDirection(false);
    // END HIDE MODAL
    ...
    sendData = () => {
        ...
        this.props.getDataDirection(data);
        this.hideModal();
    }
    // END SAVE ADD
    ...
    render() {
        return (
            <Modal show={this.props.addDirection} size="lg" backdrop="static">
                            ...
                            <div className="main-card card">
                                <div className="card-header">
                                    <span className="d-block">
                                        ...
                                        Thêm mới xu hướng phát triển, tầm nhìn
                                    </span>
                                </div>
                                <div className="card-body">
                                <PerfectScrollbar style={{maxHeight: '440px', padding: '3px'}}>
                                        <div className="position-relative row form-group">
                                            <label htmlFor="title-solution" className="col-sm-2 col-form-label">Tiêu đề (Slugan):</label>
