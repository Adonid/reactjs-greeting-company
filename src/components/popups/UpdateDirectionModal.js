...
class UpdateDirectionModal extends Component {
    constructor(props) {
        super(props);
        this.state={
            showIcon: false,
    ...
    // HIDE MODAL
    hideModal = () => this.props.hideModalEditDirection(false);
    // END HIDE MODAL
    ...
    sendData = () => {
        ...
        this.props.updateDataTechDirection(data);
        this.hideModal();
    }
    // END SAVE EIDT
    ...
    render() {
        return (
            <Modal show={this.props.editDirection} size="lg" backdrop="static">
                            ...
                            <div className="main-card card">
                                <div className="card-header">
                                    <span className="d-block">
                                        ...
                                        Sửa đặc điểm xu hướng phát triển
                                    </span>
                                </div>
