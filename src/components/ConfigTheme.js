            ...
            <div className="ui-theme-settings">
                ...
                <div className="theme-settings__inner">
                    ...
                    <div className="theme-settings__options-wrapper">
                        <h3 className="themeoptions-heading">Tùy chỉnh giao diện
                        </h3>
                        <div className="p-3">
                        <ul className="list-group">
                            ...
                            <div className="widget-content p-0">
                                ...
                                <div className="widget-content-left mr-3">
                                    ...
                                    <div className="switch-animate switch-on">
                                        <input type="checkbox" defaultChecked={true} data-toggle="toggle" data-onstyle="success" />
                                    </div>
                                    </div>
                                </div>
                                <div className="widget-content-left">
                                    <div className="widget-heading">Ghim TaskBar
                                    </div>
                                    <div className="widget-subheading">Thanh task bar sẽ được cố định khi cuộn chuột.
                                    </div>
                                </div>
                                </div>
                            </div>
                            ...
                            <div className="widget-content p-0">
                                ...
                                <div className="widget-content-left">
                                    <div className="widget-heading">Ghim thanh SlideBar
                                    </div>
                                    <div className="widget-subheading">Thanh slide bar sẽ được cố định khi cuộn chuột.
                                    </div>
                                </div>
                                </div>
                            </div>
                            ...
                            <div className="widget-content p-0">
                                ...
                                <div className="widget-content-left">
                                    <div className="widget-heading">Ghi footer
                                    </div>
                                    <div className="widget-subheading">Phần chân trang web luôn xuất hiện.
                                    </div>
                                </div>
                                </div>
                            </div>
